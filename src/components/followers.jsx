        ...
        <div className="main_container" style={{ zIndex: "9",border:"1px solid #676F76" }}>
            <div style={{borderBottom:"1px solid #676F76",marginBottom:"10px"}}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between" }}>
                    <button className="tabs active-tabs btn-outline-secondary bb border-0 rounded-0">Followers</button>
                    <button className="tabs btn btn-outline-secondary bb border-0 rounded-0"><NavLink style={{textDecoration:"none", color:"#676f76", width:"100%",height:"100%"}} to="/profile/following">Following</NavLink></button>
                </div>
            </div>
